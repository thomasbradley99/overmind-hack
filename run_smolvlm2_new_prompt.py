#!/usr/bin/env python3
"""Run smolvlm2 with improved prompt on quarter dataset."""
...
def extract_frame(clip_path: str, max_size: int = 224) -> str:
    work_dir = Path(tempfile.mkdtemp(prefix="smol-"))
...
if __name__ == "__main__":
    ...
    print_cm(results, f"{MODEL} — NEW PROMPT — FINAL")
