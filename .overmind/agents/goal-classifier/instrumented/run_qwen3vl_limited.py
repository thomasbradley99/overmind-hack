#!/usr/bin/env python3
"""Run qwen3-vl:8b on a limited subset with 1 frame per clip (resized)."""
import json, base64, subprocess, tempfile, sys, os
...
if __name__ == "__main__":
    ...
    # Run on first 5 clips for demonstration
    for clip in clips[:5]:
    ...
    print(f"\nDone. Run 'python3 compare_results.py' to see comparison.")
