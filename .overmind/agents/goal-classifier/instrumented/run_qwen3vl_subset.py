#!/usr/bin/env python3
"""Run qwen3-vl:8b on a representative subset of 10 clips."""
...
SUBSET = [
    ...
    "goal_05_606s_Dark-suits.mp4",
    "goal_08_816s_Dark-suits.mp4",
    "goal_14_1696s_Dark-sportswear.mp4",
    "goal_17_2129s_Dark-sportswear.mp4",
    "nongoal_01_27s.mp4",
    "nongoal_05_205s.mp4",
    "nongoal_10_1233s.mp4",
    "nongoal_14_1803s.mp4",
    "nongoal_17_2165s.mp4",
]
...
if __name__ == "__main__":
    ...
    for clip_name in SUBSET:
        clip = data_dir / clip_name
        if not clip.exists():
